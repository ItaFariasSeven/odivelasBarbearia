...
SECRET_KEY = 'django-insecure-d(j$xhcope#unrn18!tg_#z58r82z*$tjbotfvdvmmj5po)(t#'
...
LOGIN_REDIRECT_URL = 'agendamento:agendamento'

LOGIN_URL = 'login'

LOGOUT_REDIRECT_URL = 'agendamento:homepage'
